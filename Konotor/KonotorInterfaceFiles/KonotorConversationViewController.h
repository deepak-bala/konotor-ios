...
#define LIGHTGRAY_COLOR ([UIColor colorWithRed:0.9 green:0.9 blue:0.91 alpha:1.0])
#define CREAM_COLOR ([UIColor colorWithRed:0.95 green:0.95 blue:0.95 alpha:1.0])
...
#else
#define KONOTOR_MESSAGE_BACKGROUND_COLOR LIGHTGRAY_COLOR
#define KONOTOR_MESSAGELAYOUT_BACKGROUND_COLOR WHITE_COLOR
#define KONOTOR_SUPPORTMESSAGE_BACKGROUND_COLOR CREAM_COLOR
#endif
